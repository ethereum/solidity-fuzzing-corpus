...
contract C0 {
  modifier m0(bool i0,bytes13 i1) 
  {
    if (false)
    {
      _;
  ...
  bytes8   s2;
  int88   s3 = int88(0);
  constructor(address[] memory i0,address payable i1,bytes8 i2) payable  {
    s0 = i0;
    s1 = payable(address(this));
    s2 &= bytes8(0xc38706178054f515);
    unchecked {
    }
  }
  ...
  error er0(bool ep0, St0 ep1);
  function f0() internal  m0(false,bytes13(0xffffffffffffffffffffffffff))  returns(int64 o0)
  {
  }
}
