...
==== Source: su1.sol ====
contract C0 {
  event ev0(address payable[] indexed ep0, bytes16  ep1) anonymous;
  receive() external   payable
  {
  }
  uint168 public constant cons0 = 374144419156711147060143317175368453031918731001855;
  bytes22   s0 = bytes22(0xffffffffffffffffffffffffffffffffffffffffffff);
  address payable   s1 = payable(address(this));
}
struct St1 {
  function () external   returns (int176[5] memory, bytes memory) el0;
}
pragma solidity >= 0.0.0;
// ====
// ----
