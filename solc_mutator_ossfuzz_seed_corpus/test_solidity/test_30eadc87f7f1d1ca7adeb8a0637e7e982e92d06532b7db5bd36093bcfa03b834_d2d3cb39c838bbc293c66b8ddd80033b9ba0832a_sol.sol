...
struct St0 {
  uint216 el0;
  string el1;
  mapping(uint120 => uint248) el2;
  mapping(uint96 => bool)[4] el3;
}
contract C0 {
  bytes3  public s0;
  bytes16  public s1;
  ...
  constructor(bytes3 i0,bytes16 i1)   {
    s0 &= bytes3(0x0e842a);
    s1 |= bytes16(0xd534dfc205b781fd67315bb59377020e);
    unchecked {
    }
  }
  function f0() external virtual  payable  returns(uint128 o0)  {
  }
  enum EN0 {
...
function f1(bool i0,bool i1,address payable i2)      returns(address payable o0){
...
function f2(string memory i0)      returns(bool o0){
}
