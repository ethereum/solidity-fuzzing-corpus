...
contract C0 {
  function f1() public   payable  returns(bool o0,address o1)  {
    bool l0 = false;
  }
  struct St0 {
    address payable el0;
  ...
  {
    for(uint solinit0 = 0; solinit0 < (uint256(57894261250314392085700961108314577335419570728545489856804503414095285416721) % 11); solinit0++)
    {
  ...
  function f3(bool i0) public   payable   {
    if (i0)
    {
      if (i0)
      {
...
contract C1 {
  ...
  fallback() external   
  {
    (bool l0, bytes memory l1) = address(this).call(bytes("0c20177dc79f736162506ea72afc5c0000000000000000000000000000"));
  }
  event ev0(C1.EN1 indexed ep0, C0 indexed ep1);
  struct St1 {
    address payable el0;
  }
  enum EN2 {
  ...
  C0   s1;
  C1.EN1   s2;
  C1.St1   s3 = C1.St1(payable(address(0x0000000000000000000000000000000000000005)));
	...
	return true;
	}  int104  public s4 = int104(10141204801825835211973625643007);
  constructor(C0 i0,C1.EN1 i1)   {
