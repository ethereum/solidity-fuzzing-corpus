...
==== Source: su0.sol ====
function f0()      returns(uint112 o0,bytes memory o1,address payable o2){
}
struct St0 {
  bytes14[] el0;
  uint144 el1;
...
contract C0 {
  bytes26  public s0;
  bool   s1 = true;
  St1  public s2 = St1(payable(address(0x0000000000000000000000000000000000000005)), uint168(374144419156711147060143317175368453031918731001855));
  ...
  constructor(bytes26 i0,bytes21 i1) payable  {
    s0 = bytes26(0x5e66a82614c7e36d0e9ef8b97c4c453f852c49c2aebebf672d9f);
    s3 ^= bytes21(0xffffffffffffffffffffffffffffffffffffffffff);
    unchecked {
    }
  }
	...
	return true;
	}  function f1(bool i0,St1 calldata i1) public virtual     {
    if (i0)
    {
    }
  }
