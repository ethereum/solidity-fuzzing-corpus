...
contract C0 {
  function f0(bytes24 i0,function (bytes20, address) external   returns (string memory, address[3] memory, bytes9) i1) external   payable  returns(int72 o0)  {
    return (((((((int72(2361183241434822606847) % int72(0)) - int72(2361183241434822606847)) - int72(0)) ** uint40(uint40(401429831409))) + int72(2361183241434822606847)) & int72(2361183241434822606847)));
  }
  T1  public s0 = T1.wrap(int144(0));
  address  public s1;
  bytes29   s2 = bytes29(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
  bytes8   s3 = bytes8(0x6d75954d0cf72073);
  constructor(address i0) payable  {
    s1 = this.f0.address;
    unchecked {
      payable(this).transfer(1925784602932650382);
    }
  }
