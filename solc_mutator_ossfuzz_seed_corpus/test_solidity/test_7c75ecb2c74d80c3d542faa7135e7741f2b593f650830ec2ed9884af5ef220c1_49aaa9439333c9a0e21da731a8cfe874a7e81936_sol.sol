...
struct St0 {
  function () external   returns (T0) el0;
}

==== Source: su1.sol ====
struct St1 {
  function (address, bytes25) external   returns (int24)[] el0;
  bool el1;
  uint80 el2;
}
contract C0 {
  event ev0(function () external   returns (address, function (uint64) external  ) indexed ep0);
