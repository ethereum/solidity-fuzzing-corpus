...
struct St1 {
  mapping(bytes6 => int256) el0;
  address el1;
  function (bytes memory, function (bytes28, string memory, int232) external   returns (function (address) external   returns (uint144), bytes memory), bool) external   el2;
  function (uint160) external   returns (int144, bytes15, uint240) el3;
}
struct St2 {
  T1 el0;
  uint48 el1;
  mapping(address => bytes17) el2;
}
// ====
// ----
