...
contract C0 {
  ...
  error er0(T0 ep0);
  error er1(int80 ep0);
  function f0(address i0,St0 memory i1) public virtual  payable returns(uint32 o0,address o1)
  {
  }
  type T1 is bytes1;
}
C0.EN1 constant cons0 = C0.EN1(uint8(139));
// ====
// ----
