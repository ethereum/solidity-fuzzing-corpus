...
==== Source: su0.sol ====
contract C0 {
  mapping(int56 => bytes13)  public s0;
  address  public s1;
  bool  public s2;
  constructor(address i0,bool i1) payable  {
    s1 = address((bytes20(address(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)) & bytes20(address(0xEc68093dc5a496e21C0f9809a9a7F4133E66172A))));
    s2 = true;
    s0[int56(36028797018963967)] &= bytes13(0x7e97d496a6117bc174166ecef3);
    {
    }
  }
  struct St0 {
    uint40[1][] el0;
    bytes el1;
    function () external   returns (int192[] memory, bytes14)[] el2;
    address el3;
  }
...
function f1(int104 i0)    pure suffix returns(bytes4 o0){
}
pragma solidity >= 0.0.0;
type T0 is int192;
