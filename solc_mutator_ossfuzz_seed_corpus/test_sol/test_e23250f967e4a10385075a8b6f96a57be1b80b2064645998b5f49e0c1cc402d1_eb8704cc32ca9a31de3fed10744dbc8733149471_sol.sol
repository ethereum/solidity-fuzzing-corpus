...
contract C0 {
  ...
  bool   s0 = true;
  uint96   s1 = uint96(36323635861532175555923718182);
...
struct St0 {
  bool el0;
  function (bytes6, uint176, bytes7) external   returns (int96) el1;
  int56[][][3][3][] el2;
  mapping(bytes6 => uint40[8]) el3;
}
function f1()     returns(int216 o0)
{
...
// ----
// Warning 2072: (su0.sol:1558-1565): Unused local variable.
// Warning 2072: (su0.sol:1567-1582): Unused local variable.
// Warning 5667: (su1.sol:209-218): Unused function parameter. Remove or comment out the variable name to silence this warning.
// Warning 2072: (su1.sol:224-234): Unused local variable.
// Warning 2072: (su1.sol:296-306): Unused local variable.
// Warning 2018: (su1.sol:183-363): Function state mutability can be restricted to pure
