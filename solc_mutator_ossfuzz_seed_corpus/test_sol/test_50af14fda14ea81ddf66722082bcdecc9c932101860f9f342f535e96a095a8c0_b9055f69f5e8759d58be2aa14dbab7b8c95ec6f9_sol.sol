...
contract C0 {
  function f0(address i0,T0 i1) public virtual     {
    i1 = T0.wrap(bytes1(0xff));
    assert(i1 == T0.wrap(bytes1(0xff)));
  }
  event ev0();
  uint72  public s0 = uint72(4722366482869645213695);
  enum EN0 {
...
struct St2 {
  mapping(address => uint152) el0;
  uint208 el1;
  uint120 el2;
  mapping(uint200 => bytes25) el3;
}
