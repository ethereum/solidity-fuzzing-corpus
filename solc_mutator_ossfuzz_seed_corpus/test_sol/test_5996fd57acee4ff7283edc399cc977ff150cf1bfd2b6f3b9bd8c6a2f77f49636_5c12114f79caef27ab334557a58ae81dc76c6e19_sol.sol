...
==== Source: su0.sol ====
contract C0 {
  bool[6]   s0 = [false, true, true, false, false, false];
  ...
  constructor(bool[5] memory i0)   {
    s1 = i0;
    {
      (bool l0, bytes memory l1) = address(this).call(bytes("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff2703958a1b49"));
      bool[6] memory l2 = s0;
      bool[6] memory l3 = l2;
