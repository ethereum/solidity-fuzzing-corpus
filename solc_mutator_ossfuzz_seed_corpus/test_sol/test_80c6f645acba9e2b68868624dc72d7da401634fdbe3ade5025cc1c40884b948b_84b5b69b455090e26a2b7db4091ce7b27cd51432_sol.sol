...
contract C0 {
  ...
  constructor(bool i0,bool[][7][][][1] memory i1) payable  {
    s0 = (bytes16(0x03ef8789fdc9d9c7e4c49ce0f6543d63) != bytes16(0xffffffffffffffffffffffffffffffff));
    s1 = i1;
    {
      bool[][7][][][1] memory l0 = s1;
      bool[][7][][][1] memory l1 = l0;
      assert(compareMemoryAndStorage(l1, s1));
      bool[][7][][][1] memory l2 = s1;
