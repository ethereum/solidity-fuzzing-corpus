...
struct St0 {
  mapping(bytes3 => uint8) el0;
  uint40 el1;
  mapping(uint232 => address) el2;
}

==== Source: su1.sol ====
struct St1 {
  mapping(bytes2 => uint64) el0;
}
function f0()     {
}
struct St2 {
...
// Warning 2018: (su1.sol:110-265): Function state mutability can be restricted to pure
