...
==== Source: su0.sol ====
function f0(function (int248[][][2][8] memory, uint232, int200) external   i0,uint216 i1)     returns(address payable o0)
{
  address payable l0 = payable(msg.sender);
  bytes6 l1 = (bytes6(0x000000000000) & ((bytes6(0x000000000000) ^ bytes6(0x000000000000)) ^ bytes6(0xcd01a35d4734)));
}
type T0 is uint72;
