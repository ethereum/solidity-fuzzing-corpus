...
contract C0 {
  int208[][4][1][8]   s0;
	...
	function compareMemoryAndStorage(int208[][4][1][8] memory v1, int208[][4][1][8] storage v2) internal returns (bool) {
	...
	function compareMemoryAndStorage(int208[][4][1] memory v1, int208[][4][1] storage v2) internal returns (bool) {
		if (v1.length != v2.length)
			return false;
		for (uint i = 0; i < v1.length; i++)
  ...
  constructor(int208[][4][1][8] memory i0,address payable i1)   {
    s0 = i0;
