...
struct St1 {
  function (function (int192, function (address payable) external   returns (bytes30)) external   returns (address payable, function (bytes13[4] memory) external   returns (bytes22, function () external   returns (address payable, address payable[1] memory, bytes3)), address)) external   returns (int192, address payable, uint184) el0;
  int144 el1;
  mapping(int72 => int64) el2;
}
