...
function f0(bool i0)      returns(bytes31 o0,bytes16 o1,function (bool) external   returns (uint232, address) o2){
  (uint232 l0, address l1) = o2(false);
}
...
// ----
// Warning 3628: (su1.sol:0-325): This contract has a payable fallback function, but no receive ether function. Consider adding a receive ether function.
// Warning 5667: (su0.sol:1210-1217): Unused function parameter. Remove or comment out the variable name to silence this warning.
// Warning 5667: (su0.sol:1232-1242): Unused function parameter. Remove or comment out the variable name to silence this warning.
// Warning 5667: (su0.sol:1243-1253): Unused function parameter. Remove or comment out the variable name to silence this warning.
// Warning 2072: (su0.sol:1316-1326): Unused local variable.
