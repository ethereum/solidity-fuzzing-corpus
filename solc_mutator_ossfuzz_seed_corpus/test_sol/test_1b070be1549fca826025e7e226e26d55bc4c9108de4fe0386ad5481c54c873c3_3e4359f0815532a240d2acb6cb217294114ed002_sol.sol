...
struct St1 {
  address payable el0;
  function (address[] memory, uint176) external   returns (address) el1;
  bool el2;
  bool el3;
}
pragma solidity >= 0.0.0;
function f2(uint96 i0)    pure suffix returns(address payable o0){
  for(uint solinit0 = 0; solinit0 < (uint256(64802859752825799548972582253988152100128143411599830590257004168428637030328) % 11); solinit0++)
  {
