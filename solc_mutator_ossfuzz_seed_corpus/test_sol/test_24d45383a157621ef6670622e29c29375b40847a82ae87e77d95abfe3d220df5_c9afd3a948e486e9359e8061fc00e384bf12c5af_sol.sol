...
contract C0 {
  struct St0 {
    mapping(uint128 => int240) el0;
    mapping(int144 => bytes1) el1;
  }
  event ev0();
  uint128 immutable  s0 = uint128(312781564931773552121834196765234503343);
  C0.St0   s1;
}
type T1 is int120;
...
==== Source: su1.sol ====
pragma solidity >= 0.0.0;
error er0(function (int168) external   returns (bytes32, bytes11) ep0);
// ====
// ----
