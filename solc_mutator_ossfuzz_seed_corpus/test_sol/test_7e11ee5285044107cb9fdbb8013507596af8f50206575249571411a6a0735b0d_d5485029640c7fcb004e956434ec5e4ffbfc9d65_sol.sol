...
contract C0 {
  ...
  constructor(string memory i0,uint136 i1)   {
    s0 = string("This is a really long string that must ideally be random but is currently hard coded");
    s1 = ((((uint136(0) % uint136((uint136(0) / uint136(0)))) - uint136(87112285931760246646623899502532662132735)) ** uint72(uint72(0))) & uint136(54478792302113052567711332698668890525164));
    unchecked {
    }
  }
  fallback() external   
  ...
  int128 public constant cons0 = 0;
}
