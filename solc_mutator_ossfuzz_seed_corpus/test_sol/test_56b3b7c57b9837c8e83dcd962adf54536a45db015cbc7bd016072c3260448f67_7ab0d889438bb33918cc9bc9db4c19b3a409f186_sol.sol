...
struct St0 {
  function (function (uint32, function (bytes21[1] memory, address) internal  ) internal   returns (EN0), int232) external   returns (bool, uint192)[] el0;
}
pragma solidity >= 0.0.0;
// ----
// TypeError 2582: (su1.sol:1509-1602): Internal type cannot be used for external function type.
