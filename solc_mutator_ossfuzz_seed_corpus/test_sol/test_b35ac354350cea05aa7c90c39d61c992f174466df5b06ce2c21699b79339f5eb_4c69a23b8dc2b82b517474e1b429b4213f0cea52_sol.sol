...
contract C0 {
  ...
  constructor(bytes21 i0) payable  {
    ...
    s0[(int208(int152(2854495385411919762116571938898990272765493247)) <= ((int208(145050234985693284371392692628635748428075932038609884179722440) * int208(205688069665150755269371147819668813122841983204197482918576127)) * int208(205688069665150755269371147819668813122841983204197482918576127)))] = bytes28(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
    {
    }
  }
  ...
  event ev0(uint120[9]  ep0, uint80[6]  ep1);
  type T0 is bool;
  struct St1 {
    int104 el0;
    bytes el1;
