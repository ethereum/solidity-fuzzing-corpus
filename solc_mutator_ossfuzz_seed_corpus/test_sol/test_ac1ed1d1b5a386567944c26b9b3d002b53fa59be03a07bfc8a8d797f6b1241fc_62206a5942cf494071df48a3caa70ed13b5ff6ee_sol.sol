...
==== Source: su1.sol ====
function f0()     returns(int56 o0,bytes27 o1)
{
}
pragma solidity >= 0.0.0;
contract C0 {
  ...
  constructor(int240 i0,address payable i1,bytes memory i2)   {
    s0 = int240(883423532389192164791648750371459257913741948437809479060803100646309887);
    s1 = payable(address(this));
    s3 = bytes("ffffffff0000000000000000000000000000000000000000000000");
    {
      bytes memory l0 = s3;
      bytes memory l1 = l0;
