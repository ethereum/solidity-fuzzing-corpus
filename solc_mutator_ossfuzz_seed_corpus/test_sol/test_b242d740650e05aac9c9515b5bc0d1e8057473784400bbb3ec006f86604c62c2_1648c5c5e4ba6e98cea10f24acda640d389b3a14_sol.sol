...
library L0 {
  ...
  function f0() public   
  {
    function () external   returns (int80, bool, function (bytes12, uint176, L0.EN0) external   returns (string memory, int256)) l0;
    revert er0();
  }
}
...
pragma solidity >= 0.0.0;
library L1 {
  function f1(address payable i0,int24 i1) internal    returns(uint80 o0)
  {
  }
  event ev0(int64  ep0) anonymous;
}
