...
contract C0 {
  ...
  {
    (bool l0) = payable(this).send(15346599241231136005);
  }
  int40   s0;
  uint16   s1;
  constructor(int40 i0,uint16 i1) payable  {
    s0 *= ((int40(-284987980335) | (~(int40(0)))) + (-(int40(549755813887))));
    s1 %= uint16(65535);
    {
    }
  }
...
pragma solidity >= 0.0.0;
// ----
// Warning 2072: (su1.sol:1657-1664): Unused local variable.
// Warning 5667: (su1.sol:1757-1765): Unused function parameter. Remove or comment out the variable name to silence this warning.
