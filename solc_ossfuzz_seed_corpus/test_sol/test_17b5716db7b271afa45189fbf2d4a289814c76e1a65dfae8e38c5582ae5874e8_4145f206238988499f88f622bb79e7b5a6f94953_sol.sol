...
contract C0 {
  ...
  int112  public s2;
  constructor(bool i0,int112 i1)   {
    s0 = false;
    s2 *= (((int112(0) * (int112(216899720978262514706744613564451) * int112(126429771446387149418335984407727))) + int112(-1272671494122054503758293721146784)) ** uint104(uint104(20282409603651670423947251286015)));
    {
    }
  }
  enum EN0 {
