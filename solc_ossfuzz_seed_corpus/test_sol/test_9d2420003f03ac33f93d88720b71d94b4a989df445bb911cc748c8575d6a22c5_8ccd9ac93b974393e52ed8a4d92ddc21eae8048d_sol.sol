...
contract C0 {
  ...
  address   s2;
  address   s3;
  constructor(address i0,address i1,address i2)   {
    s1 = address(this);
    s2 = address(this);
    s3 = address(this);
    {
  ...
  function f2(address i0) private     returns(EN0 o0,EN0 o1)  {
  }
}
...
// Warning 5667: (su0.sol:974-984): Unused function parameter. Remove or comment out the variable name to silence this warning.
