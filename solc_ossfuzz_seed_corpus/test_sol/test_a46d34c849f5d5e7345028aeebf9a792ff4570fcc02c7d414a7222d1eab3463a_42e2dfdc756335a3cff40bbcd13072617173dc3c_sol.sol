...
contract C0 {
  ...
  {
    revert(string("2ccdc89c44cb225e52ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
  }
  modifier m0(uint24 i0,bytes13 i1) 
  {
    _;
    address payable l0 = payable(address(this));
    (bool l1, bytes memory l2) = payable(this).call{value: 0}("");
    address payable l3 = l0;
  }
  ...
  uint56   s2 = uint56(72057594037927935);
  constructor(address payable[][][5] memory i0)   {
    s0 = i0;
    unchecked {
      (bool l0) = payable(this).send(16979386974525068580);
    }
  }
}
library L0 {
  function f1(uint224 i0,bool i1,bool i2) public    returns(string memory o0,bool o1)
  {
    int80 l0 = int80(604462909807314587353087);
    address payable l1 = payable(address(0x0000000000000000000000000000000000000002));
  }
  function f2() public    returns(address o0,uint96 o1)
  {
    unchecked {
    }
    bytes5 l0 = (bytes5(0xffffffffff) | bytes5(0x2bc0d8b507));
  }
}
