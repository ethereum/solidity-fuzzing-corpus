...
function f0()      returns(function (address payable, uint128[1] memory, St0 memory) external   returns (bytes8, int48) o0){
}
type T1 is uint152;
...
==== Source: su1.sol ====
pragma solidity >= 0.0.0;
function f1(int232 i0)    pure suffix returns(bool o0){
}
function f2(string memory i0)    pure suffix returns(bytes19 o0){
