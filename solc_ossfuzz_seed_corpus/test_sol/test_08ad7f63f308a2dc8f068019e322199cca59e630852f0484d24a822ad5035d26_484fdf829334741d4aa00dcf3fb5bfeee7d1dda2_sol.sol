...
==== Source: su0.sol ====
library L0 {
  function f0() internal    returns(int128 o0,bytes30 o1)
  {
    function (uint88, bytes1, function () internal   returns (string memory)) internal   returns (uint128) l0;
...
contract C0 {
  ...
  using L0 for *;
  using L0 for *;
  mapping(int64 => bool)  public s0;
  constructor()   {
    s0[(-(int64(0)))] = (false ? (((int8((int8(26) / int8(-52))) + int8(0)) % int8(-62)) != int8(127)) : false);
    unchecked {
    }
  }
}
...
// Warning 2072: (su0.sol:79-184): Unused local variable.
// Warning 2072: (su0.sol:190-200): Unused local variable.
// Warning 2018: (su0.sol:15-253): Function state mutability can be restricted to pure
