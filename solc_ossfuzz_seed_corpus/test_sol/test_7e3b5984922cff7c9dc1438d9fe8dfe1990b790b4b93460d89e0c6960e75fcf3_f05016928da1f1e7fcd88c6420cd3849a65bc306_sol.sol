...
library L0 {
  ...
  function f0(function (bytes24) external   i0,function (bytes23, function (bytes memory, bytes28, bool) external   returns (int168, address payable, string memory)) external   returns (uint16) i1) internal    returns(int240 o0)
  {
    revert(string("ffffffffffffffffffffffffffffffffffffffffffffffffff"));
  }
  type T0 is bytes5;
}
using L0 for function (bytes24) external  ;
pragma solidity >= 0.0.0;
