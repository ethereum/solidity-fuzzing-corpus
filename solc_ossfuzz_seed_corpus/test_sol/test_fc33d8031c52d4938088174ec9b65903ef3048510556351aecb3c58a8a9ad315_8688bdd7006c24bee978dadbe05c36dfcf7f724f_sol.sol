...
contract C0 {
  ...
  error er0(function (int144[8] memory, bool, bool) external   ep0);
  function f1(address i0) public   payable  returns(address o0)  {
    if (i0 != this.f1.address)
    {
    }
  }
  bool  public s0 = true;
...
error er1(function (St0 memory, int112) external   ep0, St0 ep1);
...
error er2(address payable ep0, bytes7 ep1);
enum EN1 {
  M0, M1, M2, M3, M4, M5, M6, M7,
  M8, M9, M10, M11, M12, M13, M14, M15,
  M16, M17, M18, M19, M20, M21, M22, M23,
