...
==== Source: su0.sol ====
contract C0 {
  function f0() public   payable  returns(function (uint248, int176, address payable) external   returns (function () external   returns (int24, bool, bytes28)) o0,bool o1,string memory o2)  {
  }
  event ev0(address indexed ep0);
  bytes8 immutable  s0;
  mapping(address => uint80[])   s1;
