...
contract C0 {
  ...
  EN0   s1 = EN0.M29;
  EN0  public s2 = EN0.M195;
  constructor(EN0[][] memory i0)   {
    s0 = i0;
    {
      (i0[uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)]) = (new EN0[](6));
      EN0  l0 = s2;
      EN0  l1 = l0;
      assert(l1 == s2);
    }
...
// ----
// Warning 2018: (su0.sol:1807-2047): Function state mutability can be restricted to view
