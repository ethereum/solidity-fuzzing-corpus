...
pragma solidity >= 0.0.0;
library L0 {
  function f0(bytes23 i0) external    returns(uint224 o0,function () external   returns (bytes21) o1)
  {
    function (int168, int248, bool) internal   returns (bytes22[][7][][] memory, bytes memory, bool) l0;
...
// Warning 5667: (su1.sol:96-139): Unused function parameter. Remove or comment out the variable name to silence this warning.
// Warning 2072: (su1.sol:149-248): Unused local variable.
// Warning 2072: (su1.sol:254-264): Unused local variable.
// Warning 2018: (su1.sol:41-323): Function state mutability can be restricted to pure
