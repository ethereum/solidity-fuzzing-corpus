...
==== Source: su0.sol ====
struct St0 {
  function () external   returns (bytes13, uint168) el0;
  int112 el1;
}
type T0 is int176;
...
struct St1 {
  mapping(uint200 => string[6]) el0;
  mapping(bytes3 => St0) el1;
  uint248 el2;
  function (St0 memory, T0, string memory) external   returns (T0) el3;
}
