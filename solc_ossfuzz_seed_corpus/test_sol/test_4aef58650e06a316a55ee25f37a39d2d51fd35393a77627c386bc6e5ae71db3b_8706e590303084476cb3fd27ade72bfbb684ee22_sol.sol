...
function f0()      returns(address o0,address payable o1){
}
type T0 is int240;
...
contract C0 {
  ...
  constructor(uint8 i0)   {
    s2 >>= (((~((((uint8(0) & uint8(0)) & uint8(255)) % uint8(255)))) | uint8(255)) ** uint104(uint104(20282409603651670423947251286015)));
    unchecked {
    }
  }
  struct St0 {
...
contract C1 {
  ...
  struct St1 {
    mapping(address => uint64)[4] el0;
    address el1;
    mapping(bool => bool) el2;
  }
  address payable   s3 = payable(address(this));
  bytes[]  public s4 = [bytes("000000000000ffffffffffffffff")];
