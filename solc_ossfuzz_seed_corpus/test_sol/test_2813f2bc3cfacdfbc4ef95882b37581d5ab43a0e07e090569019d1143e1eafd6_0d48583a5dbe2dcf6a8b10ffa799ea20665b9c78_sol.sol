...
==== Source: su0.sol ====
function f0(string memory i0,function (address payable, bytes8) external   returns (string memory, bytes4) i1)      returns(address o0){
...
pragma solidity >= 0.0.0;
function f1(uint16 i0)    pure suffix returns(function (string memory, bytes memory) external   returns (int144, uint96, bool) o0){
  return (o0);
}
type T1 is int192;
