...
contract C0 {
  ...
  constructor(uint112 i0)   {
    s1 = (((uint112(0) ^ uint112(5192296858534827628530496329220095)) >> uint152((false ? uint152(0) : uint152(0)))) & uint112(5192296858534827628530496329220095));
    {
    }
  }
  fallback() external virtual  
  {
    s0.el0 >>= (uint104(9722735222356626880490876114869) % uint104(20282409603651670423947251286015));
  }
}
type T1 is int72;
...
contract C1 {
  ...
  function f2(bool i0,int176 i1) public      {
  }
  bytes[9]  public s2;
  ...
  bool immutable  s3;
  constructor(bytes[9] memory i0,bool i1)   {
    s2 = i0;
    s3 = false;
    unchecked {
    }
