...
==== Source: su1.sol ====
function f0()      returns(address payable o0,bytes12 o1){
  if (false)
  {
    if (false)
    {
      for(uint solinit0 = 0; solinit0 < (((uint256(0) << uint104(((~((uint104(20282409603651670423947251286015) - uint104(20282409603651670423947251286015)))) & uint104(0)))) | uint256(0)) % 11); solinit0++)
      {
        if (true)
        {
          break;
