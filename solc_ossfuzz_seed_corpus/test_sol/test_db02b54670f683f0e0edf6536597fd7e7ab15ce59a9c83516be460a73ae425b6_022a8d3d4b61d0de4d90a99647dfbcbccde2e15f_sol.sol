...
contract C0 {
  ...
  function f0(int136 i0,int136 i1) public    returns(int136 o0)
  {
    for(uint solinit0 = 0; solinit0 < (uint256(((uint256(uint112(58957467938992835865343946023518)) ^ uint256(((uint256(2039576448453229427832990658432862227695105205633254516361640468327392745930) & uint256(25896496248498552059829965118218137677059765607564012706575702719216943650026)) / uint256(0)))) / uint256(0))) % 11); solinit0++)
    {
    }
  }
...
// Warning 2018: (su1.sol:156-575): Function state mutability can be restricted to pure
