...
struct St0 {
  int144 el0;
  address[5] el1;
  function (bytes memory, function (bytes8) external   returns (int120), bytes27) external   returns (bytes21) el2;
  bool el3;
}
contract C0 {
  ...
  uint40 immutable  s0;
  int16   s1 = int16(1816);
  bytes1 immutable public s2;
  bool immutable  s3 = false;
  constructor(uint40 i0,bytes1 i1)   {
    s0 = uint40(0);
    s2 = bytes1(0x00);
    unchecked {
      for(      bytes memory l0 = bytes("32e06d231554");
true;
