...
function f0()     returns(int56 o0)
{
  revert(string("00000000000000000000000000000000000000000000000000000056847fbcdf2e7c88433eaa"));
}
pragma solidity >= 0.0.0;
EN0 constant cons0 = EN0(uint8(127));
// ====
// ----
