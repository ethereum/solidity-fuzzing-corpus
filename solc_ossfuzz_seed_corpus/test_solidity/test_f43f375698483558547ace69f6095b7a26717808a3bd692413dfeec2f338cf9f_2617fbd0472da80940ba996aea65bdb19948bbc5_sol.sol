...
==== Source: su0.sol ====
function f0(bytes memory i0,bool i1)      returns(address payable o0,int72[][2] memory o1,int16 o2){
  delete o1[(~(((((uint256((uint256(0) / uint256(0))) - uint256(41708341550683335913472182080401233008285339670371734549116010830174543560752)) << uint152(uint152(0))) << uint56(uint56(33847277101943701))) | uint256(0))))];
}
