...
contract C0 {
  ...
  St2[][8]  public s1;
	...
	function compareMemoryAndStorage(St2[][8] memory v1, St2[][8] storage v2) internal returns (bool) {
  ...
  constructor(int64 i0,int40[9] memory i1)   {
    s0 &= (((~(uint184(0))) <= uint184(24519928653854221733733552434404946937899825954937634815)) ? int40(0) : int40(0));
    s2 = i1;
    unchecked {
      (bool l0, bytes memory l1) = address(this).call(bytes("00000000000000000000000000000000ffffffffffffffffffffffffffffff"));
    }
  }
  event ev0() anonymous;
}
