...
==== Source: su1.sol ====
pragma solidity >= 0.0.0;
function f0(int224 i0,bool i1)      returns(uint96 o0,address payable o1,function (bytes21, uint200) external   returns (address payable, uint64) o2){
  require(false);
}
function f1(address payable i0,address i1)     {
  if (i0 != payable(address(0x0000000000000000000000000000000000000001)))
  {
  }
  else if (i1 <= address(0x0000000000000000000000000000000000000007))
  {
  }
}
