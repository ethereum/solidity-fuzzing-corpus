...
contract C1 {
  ...
  int232   s1 = int232(0);
  bytes29  public s2;
  C1.T0 immutable  s3 = C1.T0.wrap(uint144(3656016540437182680821111449228272127312957));
  constructor(bytes29 i0)   {
    s2 &= bytes29(0x6da6214a9de6db22499a58ddbcbbfa909ded5b58b1403eaa08a66cf19f);
    unchecked {
    }
  }
  event ev0();
