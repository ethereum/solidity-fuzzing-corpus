...
contract C0 {
  ...
  int224   s1;
  T0   s2;
  constructor(int224 i0,T0 i1)   {
    s1 += (int224(13479973333575319897333507543509815336818572211270286240551805124607) & (((int136(43556142965880123323311949751266331066367) % int136(3503850073338988478452515845745930675796)) ** uint168(uint168(0))) + int224(13479973333575319897333507543509815336818572211270286240551805124607)));
    s2 = T0.wrap(payable(address(0x0000000000000000000000000000000000000008)));
    {
    }
  }
  struct St0 {
