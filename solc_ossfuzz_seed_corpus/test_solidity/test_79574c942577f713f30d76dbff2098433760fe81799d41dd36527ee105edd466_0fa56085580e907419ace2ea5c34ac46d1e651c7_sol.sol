...
==== Source: su0.sol ====
contract C0 {
  function f0() external virtual    returns(bool o0,bool o1,int96 o2)  {
    (bool l0, bytes memory l1) = address(this).call(bytes("0000000000000000000000000000eaad265ca24cbb31302387e9bb5c1d880eeb"));
  }
  type T0 is uint184;
  enum EN0 {
