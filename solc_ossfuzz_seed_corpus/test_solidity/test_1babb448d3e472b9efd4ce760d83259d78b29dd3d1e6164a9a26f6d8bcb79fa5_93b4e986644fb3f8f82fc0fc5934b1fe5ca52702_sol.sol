...
struct St0 {
  string el0;
  function (address, int216) external   returns (address payable) el1;
}
...
error er0(address ep0, C0.EN0[] ep1);
type T0 is bool;
