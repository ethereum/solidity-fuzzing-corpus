...
struct St1 {
  function (int112) external   returns (T1) el0;
  T1 el1;
  int56 el2;
  mapping(bytes15 => int8)[] el3;
}
function f0(address payable i0)      returns(function (function (bool) external   returns (bool), function (int184, St0 memory, int64) external  ) external   returns (int80) o0){
  return (o0);
}
// ====
// ----
