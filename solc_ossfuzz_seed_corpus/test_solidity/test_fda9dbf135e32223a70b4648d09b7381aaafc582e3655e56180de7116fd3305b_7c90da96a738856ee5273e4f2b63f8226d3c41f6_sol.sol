...
;
  ...
  function f1(int96 i0) external    returns(int152 o0,bytes25[1] memory o1)
  {
...
// Warning 5667: (su0.sol:271-291): Unused function parameter. Remove or comment out the variable name to silence this warning.
// Warning 2072: (su0.sol:301-311): Unused local variable.
// Warning 2018: (su0.sol:127-185): Function state mutability can be restricted to pure
