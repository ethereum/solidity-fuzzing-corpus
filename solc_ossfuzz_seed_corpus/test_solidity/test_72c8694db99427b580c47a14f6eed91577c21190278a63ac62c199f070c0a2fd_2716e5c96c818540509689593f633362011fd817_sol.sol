...
struct St0 {
  uint40 el0;
  function (bool) external   returns (uint144, int112) el1;
  bool el2;
  address payable el3;
}
...
contract C0 {
  ...
  event ev1(function () external   returns (int224, St1 memory, int208)  ep0, address  ep1);
...
contract C1 {
  ...
  event ev2(St1  ep0, bytes indexed ep1, int256[]  ep2);
  St1   s1;
