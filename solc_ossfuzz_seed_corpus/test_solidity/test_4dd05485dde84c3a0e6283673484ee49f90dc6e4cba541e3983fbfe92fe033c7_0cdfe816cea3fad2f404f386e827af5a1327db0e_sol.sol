...
contract C0 {
  T0   s0 = T0.wrap(true);
  mapping(address => T0)  public s1;
  mapping(T0 => int248)   s2;
  bytes12  public s3 = bytes12(0xffffffffffffffffffffffff);
  constructor() payable  {
    s1[address(this)] = s1[address(this)];
    s2[T0.wrap(false)] += (~(s2[T0.wrap(true)]));
    unchecked {
    }
  }
  enum EN0 {
  ...
  bytes17 public constant cons0 = bytes17(0xd71606f9fb30f9c46e71c1f2f3400aa7ed);
}
