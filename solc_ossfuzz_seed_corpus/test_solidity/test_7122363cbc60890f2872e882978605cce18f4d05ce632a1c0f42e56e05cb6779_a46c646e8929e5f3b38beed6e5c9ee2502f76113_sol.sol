...
contract C0 {
  function f0() public virtual    returns(uint48 o0,address o1,int152 o2)  {
    (bool l0, bytes memory l1) = address(this).call(bytes("00000000000000000000000000000000000000000059"));
    return (uint48(55624712624259), msg.sender, (int152(-2313304844593463559743492321854029754266296743) + int152(2854495385411919762116571938898990272765493247)));
  }
  mapping(int200 => bool[])  public s0;
