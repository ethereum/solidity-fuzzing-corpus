...
library L0 {
  ...
  type T0 is uint80;
  function f1(int120 i0,bytes31 i1) public    returns(address payable o0,function (L0.T0[2] memory) external   o1)
  {
  }
  event ev0(int24  ep0) anonymous;
}
pragma solidity >= 0.0.0;
function f2(int232 i0)     returns(L0.T0 o0,bytes memory o1)
{
}
enum EN0 {
