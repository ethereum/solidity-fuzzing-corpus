...
contract C {
	...
	function test() public returns (uint) {
		x_0 = 0x0000000000000000000000000000000000000095484008f6362f93160ef3e563;


		int168 x_1;
		x_1 = 0x00000000000000000000000988386fc84ba6bc95484008f6362f93160ef3e563;
	...
	function coder_public(uint104 c_0, int168 c_1) public pure returns (uint) {
		if (c_0 != 0x0000000000000000000000000000000000000095484008f6362f93160ef3e563) return 1;
		if (c_1 != 0x00000000000000000000000988386fc84ba6bc95484008f6362f93160ef3e563) return 2;

		return 0;
	}

	function coder_external(uint104 c_0, int168 c_1) external pure returns (uint) {
		if (c_0 != 0x0000000000000000000000000000000000000095484008f6362f93160ef3e563) return 1;
		if (c_1 != 0x00000000000000000000000988386fc84ba6bc95484008f6362f93160ef3e563) return 2;
