...
contract C {
	...
	function coder_returndata_external() external returns (S0 memory, bool) {
		address payable[] memory lv_2 = new address payable[](2);
		lv_2[0] = address(0x0000000000000000000000002f12db2869c3395a3b0502d05e2516446f71f85b);
		lv_2[1] = address(0x0000000000000000000000004fd709f28e8600b4aa8c65c6b64bfe7fe36bd19b);
		sv_0.m1.push(lv_2);
		bool lv_1 = true;
		return (sv_0, lv_1);
	}
